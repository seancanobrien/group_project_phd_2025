...
\todo[color=pink]{Hi Talia, I've had a read through this, fixed a couple of typos and added a few comments- please ignore these if they're wrong! -Lorna :)}We now reach the topic of ends of groups. In this chapter, we explore the relationship between the number of ends of a finitely generated group and the algebraic structure of these groups as amalgams and HNN-extensions. An important result in this area is Stallings’ Structure Theorem \cite[p.~4]{S71}, which classifies finitely generated groups with more than one end:
...
\todo[color=pink]{Not a comment, I just think this picture is really cool! -Thank you!}
