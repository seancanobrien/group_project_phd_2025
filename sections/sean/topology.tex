...
\begin{example}
	...
	\]
\end{example}
From the previous example, we see that any edge path in $\abs{C\calg}$ is homotopic to a path which moves between vertices via the relevant identity element, and possibly completes some loop at each vertex.
