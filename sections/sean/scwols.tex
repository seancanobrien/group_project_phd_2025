...
\begin{definition}
	An action of a group $G$ on a scwol $\catx$ is a homomorphism from $G$ to the group of non-degenerate automorphisms of $\catx$ such that the following two conditions are met.
	\begin{enumerate}
