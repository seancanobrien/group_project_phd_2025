...
\todo[color=olive]{A moral question: do we actually need scwols for the above example, i.e. the triangle? }
...
This is important because we want to be able to quotient by this group action and for the quotient map \todo[color=olive]{Is $X$ written in the right font? } to be simplicial on $\abs{X}$.
