...
\begin{proof}[Sketch of proof]
	...
	We should check that $\caly_\psi$ is well-defined as a scwol, but we omit these checks.
	...
	Since this action acts transitively on the cosets, we get a natural isomorphism between $G \backslash \caly_\psi$ and  $\calx$.
	Let $p \colon \caly_\psi \to \calx$ be this projection.
	When constructing the complex of groups associated to this action, we need to make choices of representatives with respect to $p$.
	We make the natural choice of $(1_\sigma G_\sigma, \sigma)$ for each $\sigma \in V(\calx)$.
	The natural choice for each  $h_a$ is $\theta_a$.
	Given these choices, A
	\todo{finish this}
\end{proof}
