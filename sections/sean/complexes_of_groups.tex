...
\begin{definition}[Complex of groups associated to an action on a scwol]
...
\begin{definition}[Morphisms of complexes of groups]
...
\end{definition}
\todo[color=olive]{I have noticed, that in this definition and some of the prevoius ones it's not emphasised which concept us actually being defined.
	Maybe it would be worth to do that?}
