...
\begin{remark}
    The converse of the proposition \ref{solv} is also supposed to be true. However, because we omit the proof of the convers statement, the result was stated only one way.
\end{remark}
...
\subsubsection{Properties and results}
