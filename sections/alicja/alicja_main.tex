...
\begin{enumerate}
    ...
    \todo{I was under the impression that Mal'cev's theorem was that linear groups are res. finite, and that res finite implies hopfian was `classical'}
...
\todo{fix sentence}
In the previous section we saw the connections certain trees and graphs of groups. It should then come as no surprise that we can define our group in terms of one or the other. 
